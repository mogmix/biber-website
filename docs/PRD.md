...
[Vereinsname] e.V. is a Berlin-based volunteer association of ~10 members dedicated to the observation and conservation of beavers (*Castor fiber*). The association needs a lightweight, members-only web portal centred on one core feature:
